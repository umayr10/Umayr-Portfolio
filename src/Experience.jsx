    ...
    {/*Experience*/}
        <div>
            ...
            <div className='flex flex-col justify-center items-center  text-center gap-4'>
                <h1 className='text-2xl font-semibold'>NCU Technologies</h1>
                <p> Sep 2024 - April 2025 </p>
